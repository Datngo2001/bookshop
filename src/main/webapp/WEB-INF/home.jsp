    ...
    <div class="adver-demo">
      <div class="owl-carousel owl-theme">
        <div class="adver-item">
          <a href=""
            ><img
              src="https://www.epub.vn/static/assets/bigbanner/webp/the-overweight-book-shelf-colour-pc.webp?v=1"
              alt=""
            />
          </a>
        </div>
        <div class="adver-item">
          <a href=""
            ><img
              src="https://www.epub.vn/static/assets/bigbanner/webp/who-was-pc.webp?v=1"
              alt=""
            />
          </a>
        </div>
        <div class="adver-item">
          <a href=""
            ><img
              src="https://www.epub.vn/static/assets/bigbanner/webp/about-us-banner-pc.webp?v=1"
              alt=""
            />
          </a>
        </div>
        <div class="adver-item">
          <a href=""
            ><img
              src="https://www.epub.vn/static/assets/bigbanner/webp/harry-potter-pc.webp?v=1"
              alt=""
            />
          </a>
        </div>
          ...
          <div class="grid_column-2">
            <nav class="category">
              <h3 class="category-heading">
                <i class="category-heading-icon fas fa-list"></i>Content
              </h3>
          ...
          <div class="grid_column-10">
            <div class="home-filter">
              <div class="sort-by">
                ...
                <button class="btn-product btn-primary home-filter-btn">
                  Newest
                </button>
                ...
                <ul class="select-input-list">
                  <li class="select-input-item">
                    <form action="">
                      ...
                      <button class="select-input-link btn-sort">
                        Increase
                      </button>
                    </form>
                  </li>
              ...
              <div class="home-page">
                <div class="filter-control" style="display: flex">
                  ...
                  <form action="home" method="post">
                    ...
                    <button type="submit" class="filter-page-btn">
                    ...
                    <div class="card-trending">
                      <div class="product-item border-card">
                        ...
                        <div class="product-action">
                          <span
                            class="product-action-heart product-action-liked"
                          >
                        ...
                        <div class="trending-item-price">
                          ...
                          <span class="price-current mr-up"
                            >${product.getPriceDiscount()}</span
                          >
                        </div>
                        <form
        ...
        <div class="trending_book">
          <div class="trending_book-header">
            ...
            <ul class="trending-list">
              <li class="trending_item">
                <a href="" class="trending_item-link">Discount</a>
              </li>
              <li class="trending_item">
                <a href="" class="trending_item-link">Newest</a>
              </li>
              <li class="trending_item">
                <a href="" class="trending_item-link">See All</a>
              </li>
            </ul>
          </div>
            ...
            <c:forEach var="item" items="${trending_book}">
              ...
              <div class="card-trending">
                <div class="product-item border-card">
                  ...
                  <c:choose>
                    <c:when test="${item.discount == 0 }"> </c:when>
                    <c:otherwise>
                      <div class="product-item-sale">
                        <span class="product-item-label">Discount</span>
                        <span class="product-item-percent"
                          >${item.getDiscount()}%</span
                        >
                      </div>
                    </c:otherwise>
                  </c:choose>
          ...
          <div class="trending_book">
            <div class="trending_book-header">
              <span class="trending_book-title"
                >Popular eBook Pre-orders <br />
                <p class="trending_book-title-after">
                  Stay ahead of the curve and get the most anticipated eBooks of
                  the year the moment they come out.
                </p></span
              >
          ...
          <div class="trending_book">
            <div class="trending_book-header">
              <span class="trending_book-title"
                >Romance Book<br />
                <p class="trending_book-title-after">
                  Any of the romance book titles that you score through this
                  generator are yours to use.
                </p></span
              >
              <ul class="trending-list mrtop">
                <li class="trending_item">
